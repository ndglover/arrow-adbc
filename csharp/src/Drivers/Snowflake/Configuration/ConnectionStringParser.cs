...
namespace Apache.Arrow.Adbc.Drivers.Snowflake.Configuration
{
    ...
    {
        /// <summary>
        /// Parses ADBC parameters dictionary into a ConnectionConfig object.
        /// </summary>
        /// <param name="parameters">The ADBC parameters dictionary.</param>
        ...
        public static ConnectionConfig ParseParameters(IReadOnlyDictionary<string, string> parameters)
        {
            ArgumentNullException.ThrowIfNull(parameters, nameof(parameters));
            return BuildConfig(new Dictionary<string, string>(parameters, StringComparer.OrdinalIgnoreCase));
        }
